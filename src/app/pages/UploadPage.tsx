    ...
    >
      ...
      <div style={{ marginTop: 40 }}>
        ...
        >
          ...
          >
            Click a specimen to load it as your test image
          </span>
        </div>
        ...
        >
          {DEMO_IMAGES.map(demo => (
            <motion.button
              ...
              onClick={() => {
                const uploadedFile: UploadedFile = {
                  name: `${demo.id}-specimen.svg`,
                  format: 'SVG',
                  resolution: '512 × 512',
                  colorMode: demo.imageType === 'Fingerprint' || demo.imageType === 'Biomedical' ? 'Grayscale' : 'RGB',
                  sizeKB: 12,
                  dataUrl: demo.src,
              ...
              style={{
                ...
                gap: 0,
                background: 'white',
                border: `1px solid ${file?.imageType === demo.imageType && !isDemo ? demo.accent + '60' : 'var(--rule)'}`,
                borderRadius: 'var(--r-md)',
                overflow: 'hidden',
                cursor: 'pointer',
                textAlign: 'left',
                ...
                boxShadow: file?.imageType === demo.imageType && !isDemo
                  ? `0 0 0 2px ${demo.accent}22`
                  : 'var(--shadow-paper)',
              }}
            >
              {/* Specimen thumbnail */}
